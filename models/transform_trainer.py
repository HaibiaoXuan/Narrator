...
from dataset import CompositeFrameDataset
from data.scene import scenes, to_trimesh, to_open3d
from models.smplx_regressor import SMPLX_Regressor
from models.loss import *
from models.module import InteractionVAE
from utils.utils import *
from utils.viz_util import render_obj_multview
...
if __name__ == '__main__':
    ...
    parser.add_argument("--second_stage", type=int, default=20, help="annealing some loss weights in early epochs before this num")
